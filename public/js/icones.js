...
(function (globalThis_, factory) {
  ...
  const TRACÉS = {
    ...
    pause: { cls: 'ico-pause', svg: '<path data-cible="a" d="M9.6 7.6v8.8M14.4 7.6v8.8"/><circle cx="12" cy="12" r="8.6"/>' },
    son: { cls: 'ico-son', svg: '<path d="M4.4 9.6h3.1L11.6 6v12L7.5 14.4H4.4z"/><path data-cible="a" d="M15 9.4a3.6 3.6 0 0 1 0 5.2M17.7 7.2a7 7 0 0 1 0 9.6"/>' },
    muet: { cls: 'ico-muet', svg: '<path d="M4.4 9.6h3.1L11.6 6v12L7.5 14.4H4.4z"/><path data-cible="a" d="m15.2 9.8 4.8 4.4M20 9.8l-4.8 4.4"/>' },
